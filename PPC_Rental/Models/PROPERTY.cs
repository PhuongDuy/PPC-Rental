...
namespace PPC_Rental.Models
{
    ...
    public partial class PROPERTY
    {
        ...
        [Required(ErrorMessage = "Chưa điền tiêu đề")]
        public string PropertyName { get; set; }
        public string Avatar { get; set; }
        public string Images { get; set; }
        public Nullable<int> PropertyType_ID { get; set; }
        [Required(ErrorMessage = "Chưa điền nội dung")]
        public string Content { get; set; }
        public Nullable<int> Street_ID { get; set; }
        public Nullable<int> Ward_ID { get; set; }
        public Nullable<int> District_ID { get; set; }
        [Required(ErrorMessage = "Chưa điền giá")]
        public Nullable<int> Price { get; set; }
        public string UnitPrice { get; set; }
        [Required(ErrorMessage = "Chưa điền diện tích")]
